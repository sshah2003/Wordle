...
class WordGenerator {
  ...
  static let possibleWords = ["APPLE", "WORDS", "TRUNK", "PASTA", "CRATE", "WHERE", "PSALM", "PLANT", "TABLE", "CHAIR", "LIGHT", "MOUSE", "HOUSE", "FLOOR", "WATER", "CLOUD", "SHEET", "MUSIC", "STAIR", "CARDS", "PAPER", "SPOON", "WATCH", "STONE", "GLASS", "CANDY", "DOORS"]
